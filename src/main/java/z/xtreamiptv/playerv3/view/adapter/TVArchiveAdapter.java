...
import z.xtreamiptv.playerv3.view.activity.SubTVArchiveActivity;
...
//    }
    ...
    public void filter(final String text, final TextView tvNoRecordFound) {
        new Thread(new Runnable() {
            ...
            class C19821 implements Runnable {
                C19821() {
                }
            ...
            public void run() {
                ...
                ((Activity) TVArchiveAdapter.this.context).runOnUiThread(new C19821());
            }
        }).start();
    }
}
