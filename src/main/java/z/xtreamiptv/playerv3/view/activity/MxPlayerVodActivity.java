...
public class MxPlayerVodActivity extends AppCompatActivity {
    ...
    public void mxPlayerNotFoundDialogBox() {
        ...
        builder.setPositiveButton(getResources().getString(R.string.install_it), new C18141());
        builder.setNegativeButton(getResources().getString(R.string.cancel_small), new C18152());
