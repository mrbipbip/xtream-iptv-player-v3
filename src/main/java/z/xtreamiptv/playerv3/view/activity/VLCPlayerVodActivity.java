...
public class VLCPlayerVodActivity extends AppCompatActivity {
    ...
    class C18852 implements OnClickListener {
        C18852() {
        }
    ...
    public void vlcPlayerNotFoundDialogBox() {
        ...
        builder.setPositiveButton(getResources().getString(R.string.install_it), new C18841());
        builder.setNegativeButton(getResources().getString(R.string.cancel_small), new C18852());
