...
public class VLCPlayerSeriesActivity extends AppCompatActivity {
    ...
    class C18821 implements OnClickListener {
        C18821() {
        }
    ...
    class C18832 implements OnClickListener {
        C18832() {
        }
    ...
    public void vlcPlayerNotFoundDialogBox() {
        ...
        builder.setPositiveButton(getResources().getString(R.string.install_it), new C18821());
        builder.setNegativeButton(getResources().getString(R.string.cancel_small), new C18832());
