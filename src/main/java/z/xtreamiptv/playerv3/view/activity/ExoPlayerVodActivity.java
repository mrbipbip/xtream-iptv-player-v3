...
public class ExoPlayerVodActivity extends Activity implements OnClickListener {
    ...
    class C17821 implements OnPreparedListener {

        class C17811 implements OnVideoSizeChangedListener {
            C17811() {
            }
        ...
        public void onPrepared(MediaPlayer mp) {
            mp.start();
            mp.setOnVideoSizeChangedListener(new C17811());
        }
    }

    class C17832 implements OnErrorListener {
        C17832() {
        }
    ...
    public void preparePlayer() {
        ...
        this.videoView.setOnPreparedListener(new C17821());
        this.videoView.setOnErrorListener(new C17832());
    }
