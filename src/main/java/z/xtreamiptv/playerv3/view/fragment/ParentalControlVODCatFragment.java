...
import z.xtreamiptv.playerv3.view.adapter.ParentalControlVODCatAdapter;
...
public class ParentalControlVODCatFragment extends Fragment {
    ...
    class C20291 implements OnQueryTextListener {
        C20291() {
        }
    ...
    class C20302 implements OnClickListener {
        C20302() {
        }

        public void onClick(DialogInterface dialog, int which) {
            Utils.loadChannelsVodandSeries(ParentalControlVODCatFragment.this.context);
        }
    }

    class C20313 implements OnClickListener {
        C20313() {
        }
    ...
    class C20324 implements OnClickListener {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ParentalControlVODCatFragment.this.loadTvGuid();
        }
    }

    class C20335 implements OnClickListener {
        C20335() {
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_search:
                ...
                this.searchView.setOnQueryTextListener(new C20291());
                return true;
            case R.id.menu_load_channels_vod1:
                ...
                alertDialog.setPositiveButton("YES", new C20302());
                alertDialog.setNegativeButton("NO", new C20313());
                alertDialog.show();
                return true;
            case R.id.menu_load_tv_guide1:
                ...
                alertDialog1.setPositiveButton("YES", new C20324());
                alertDialog1.setNegativeButton("NO", new C20335());
                alertDialog1.show();
                return true;
        }
        return false;
