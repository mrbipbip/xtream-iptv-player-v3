...
public class PlayerArchiveActivity extends Activity implements OnClickListener, VisibilityListener {
    ...
    private static final Map<Integer, Integer> RESIZE_MODE = Collections.unmodifiableMap(new C20061());
    ...
    static class C20061 extends HashMap<Integer, Integer> {
        C20061() {
    ...
    class C20072 implements MediaSourceFactory {
        C20072() {
        }
    ...
    private MediaSource createAdsMediaSource(MediaSource mediaSource, Uri adTagUri) throws Exception {
        ...
        return new AdsMediaSource(mediaSource, new C20072(), this.adsLoader, this.adUiViewGroup, this.mainHandler, this.eventLogger);
    }
