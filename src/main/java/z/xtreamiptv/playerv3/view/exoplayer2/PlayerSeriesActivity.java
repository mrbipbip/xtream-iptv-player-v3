...
public class PlayerSeriesActivity extends Activity implements OnClickListener, VisibilityListener {
    ...
    private static final Map<Integer, Integer> RESIZE_MODE = Collections.unmodifiableMap(new C20081());
    ...
    static class C20081 extends HashMap<Integer, Integer> {
        C20081() {
    ...
    class C20092 implements MediaSourceFactory {
        C20092() {
        }
    ...
    private void initializePlayer() {
        ...
        String stream_ext = getIntent().getStringExtra("EXTENSION_TYPE");
        ...
        if (needNewPlayer || this.needRetrySource) {
            ...
            if ("com.google.android.exoplayer.demo.action.VIEW".equals(action)) {
                uris = new Uri[]{buildURI(video_id, this.extension, stream_stop_time, stream_start_time, stream_ext)};
    ...
    private MediaSource createAdsMediaSource(MediaSource mediaSource, Uri adTagUri) throws Exception {
        ...
        return new AdsMediaSource(mediaSource, new C20092(), this.adsLoader, this.adUiViewGroup, this.mainHandler, this.eventLogger);
    }
