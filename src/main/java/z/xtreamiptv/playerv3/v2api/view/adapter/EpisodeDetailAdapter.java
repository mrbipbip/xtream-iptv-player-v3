        ...
        if (this.context != null) {
            ...
            if (this.dataSet.get(listPosition) != null) {
                ...
                if (StreamIcon != null && !StreamIcon.equals("")) {
                    Picasso.with(this.context).load(StreamIcon).placeholder((int) R.drawable.iptv_placeholder).into(holder.MovieImage);
                } else if (VERSION.SDK_INT >= 21) {
                    holder.MovieImage.setImageDrawable(this.context.getResources().getDrawable(R.drawable.iptv_placeholder, null));
                } else {
                    holder.MovieImage.setImageDrawable(ContextCompat.getDrawable(this.context, R.drawable.iptv_placeholder));
                }
    ...
    public void filter(final String text, final TextView tvNoRecordFound) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                ((Activity) EpisodeDetailAdapter.this.context).runOnUiThread(new C15791());
            }
        }).start();
    }
}
