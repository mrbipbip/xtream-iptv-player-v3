...
public class VodFragment extends Fragment implements OnNavigationItemSelectedListener {
    ...
    class C16871 implements OnQueryTextListener {
        C16871() {
        }
    ...
    class C16882 implements OnClickListener {
        C16882() {
        }

        public void onClick(DialogInterface dialog, int which) {
            Utils.loadChannelsAndVodV2Api(VodFragment.this.context);
        }
    }

    class C16893 implements OnClickListener {
        C16893() {
        }
    ...
    class C16904 implements OnClickListener {
        C16904() {
        }

        public void onClick(DialogInterface dialog, int which) {
            Utils.loadTvGuidV2Api(VodFragment.this.context);
        }
    }

    class C16915 implements OnClickListener {
        C16915() {
        }
    ...
    class C16926 implements View.OnClickListener {
        C16926() {
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout1) {
            ...
            this.searchView.setOnQueryTextListener(new C16871());
            return true;
            ...
            alertDialog.setPositiveButton("YES", new C16882());
            alertDialog.setNegativeButton("NO", new C16893());
            alertDialog.show();
            return true;
            ...
            alertDialog.setMessage(getResources().getString(R.string.confirm_procees));
            alertDialog.setIcon(R.drawable.questionmark);
            alertDialog.setPositiveButton("YES", new C16904());
            alertDialog.setNegativeButton("NO", new C16915());
            alertDialog.show();
            return true;
        } else {
    ...
    private void showSortPopup(Activity context) {
        ...
        closedBT.setOnClickListener(new C16926());
    ...
    private void setUpdatabaseResult() {
        if (this.context != null) {
            ...
            if (!this.getActiveLiveStreamCategoryId.equals("-1")) {
                ArrayList<LiveStreamsDBModel> channelAvailable = vodStreamsDatabaseHandler.getAllVODStreasWithCategoryId(this.getActiveLiveStreamCategoryId);
                onFinish();
    ...
    public void getAllMovies() {
        ...
        if (this.context != null) {
            ...
            ArrayList<LiveStreamsDBModel> channelAvailable = vodStreamsDatabaseHandler.getAllVODStreasWithCategoryId(AppConst.PASSWORD_UNSET);
