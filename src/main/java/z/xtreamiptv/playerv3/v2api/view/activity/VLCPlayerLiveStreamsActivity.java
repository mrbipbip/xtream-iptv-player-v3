...
public class VLCPlayerLiveStreamsActivity extends AppCompatActivity {
    ...
    class C15522 implements OnClickListener {
        C15522() {
        }
    ...
    public void vlcPlayerNotFoundDialogBox() {
        ...
        builder.setPositiveButton(getResources().getString(R.string.install_it), new C15511());
        builder.setNegativeButton(getResources().getString(R.string.cancel_small), new C15522());
