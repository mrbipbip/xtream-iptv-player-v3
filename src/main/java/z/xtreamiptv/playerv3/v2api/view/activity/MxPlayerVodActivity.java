...
public class MxPlayerVodActivity extends AppCompatActivity {
    ...
    class C14871 implements OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int id) {
            try {
                MxPlayerVodActivity.this.startActivity(new Intent("android.intent.action.VIEW", Uri.parse("market://details?id=com.mxtech.videoplayer.ad")));
            } catch (ActivityNotFoundException e) {
                try {
                    MxPlayerVodActivity.this.startActivity(new Intent("android.intent.action.VIEW", Uri.parse("http://play.google.com/store/apps/details?id=com.mxtech.videoplayer.ad")));
                } catch (ActivityNotFoundException exception) {
                    Utils.showToast(MxPlayerVodActivity.this.context, String.valueOf(exception));
                }
            }
        }
    }
    ...
    class C14882 implements OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int id) {
            MxPlayerVodActivity.this.finish();
        }
    }
    ...
    public void mxPlayerNotFoundDialogBox() {
        ...
        builder.setPositiveButton(getResources().getString(R.string.install_it), new C14871());
        builder.setNegativeButton(getResources().getString(R.string.cancel_small), new C14882());
