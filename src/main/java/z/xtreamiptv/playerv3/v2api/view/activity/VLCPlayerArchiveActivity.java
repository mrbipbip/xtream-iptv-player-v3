...
public class VLCPlayerArchiveActivity extends AppCompatActivity {
    ...
    class C15491 implements OnClickListener {
        C15491() {
        }
    ...
    public void vlcPlayerNotFoundDialogBox() {
        ...
        builder.setPositiveButton(getResources().getString(R.string.install_it), new C15491());
        builder.setNegativeButton(getResources().getString(R.string.cancel_small), new C15502());
